...
class KidsSection extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> gridMap = const[
    {
      "title": "Biker Outfit for Kids.",
      "price": "Rs.5000",
      "images": "assets/images/kids/kimg1.webp",
    },
    {
      "title": "Nike Track-Suits",
      "price": "Rs. 6000",
      "images": "assets/images/kids/kimg2.webp",
    },
    {
      "title": "Durable Cargo Pants",
      "price": "Rs.1000",
      "images": "assets/images/kids/kimg3.webp",
    },
    {
      "title": "Biker Outfit for Kids.",
      "price": "Rs.6000",
  ...
  final List<String> imgList =const [
    'assets/images/kids/kimg1.webp',
    'assets/images/kids/kimg2.webp',
    'assets/images/kids/kimg3.webp',
    'assets/images/kids/kimg1.webp',
    'assets/images/kids/kimg2.webp',
    'assets/images/kids/kimg3.webp',
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(title: const Text('Kids\'s Section',style: TextStyle(fontSize: 25,color: Colors.white),),
          centerTitle: true,
